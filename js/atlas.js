...
// --- 農業ブロック ---------------------------------------------------------
// FARMLAND_DRY 耕地（乾）: 土を整地した畝。横方向の溝が並ぶ茶色の土。
...
// FARMLAND_WET 耕地（湿）: 水を含んだ濃い土。畝の溝が暗く湿っている。
...
// 作物の共通描画: 透明背景に縦の茎を生やす。stage(0..1)で高さ・色が変化。
